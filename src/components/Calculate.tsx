...
// import drawing_img from "../assets/drawing.jpg";
...
// // Define the Controls type (assuming it is from framer-motion)
...
//   const controls: Controls = useAnimation();
...
//         <img src={drawing_img} alt="mep unity logo" className='background_for_logo' />
...
//         <h1 className='slogan'>Future Projects</h1>``
//       </div>
//     </div>
//   )
// }
